 ...
 * @version 1.0.0 
 */
@XmlRootElement(name="DataElement", namespace="http://www.wfmc.org/2009/BPAF2.0")
@XmlAccessorType(XmlAccessType.FIELD)
public class EventData implements Comparable<EventData>, Serializable {
	/** Serial Version UID */
	 ...
	 */
	@Override
	public int compareTo(EventData data) {
		if (data == null)
			return -1;	
		if (key == null)
			return 1;
